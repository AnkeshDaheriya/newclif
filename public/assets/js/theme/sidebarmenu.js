// First fix the layout attribute check - the previous check was an assignment, not a comparison
var at = document.documentElement.getAttribute("data-layout");
if (at === "vertical") {
  // Changed from single = to ===
  // ----------------------------------------
  ...
  // Add null check for get-url element
  ...
  document
    ...
    .forEach(function (link) {
      ...
      if (parentUl) {
        ...
        var parentElement = parentUl.parentElement;
        if (parentElement) {
...
if (at === "horizontal") {
  ...
  document
    ...
    .forEach(function (link) {
      const closestA = link.closest("a");
      if (closestA && closestA.parentElement) {
        closestA.parentElement.classList.add("selected");
      }
      const closestUl = link.closest("ul");
      if (closestUl && closestUl.parentElement) {
