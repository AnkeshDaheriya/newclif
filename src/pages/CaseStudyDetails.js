...
const CaseDetails = () => {
  ...
  const getCaseData = allCaseData.filter(
    (data) => slugify(data.title) === caseSlug
  );
              ...
              <div className="col-lg-6">
                <div className="case-study-featured-thumb">
                  <Tilty perspective={2000}>
                    <img
                      src={process.env.PUBLIC_URL + detailsCase.thumb}
                      alt="Case Study"
                    />
                  </Tilty>
                </div>
