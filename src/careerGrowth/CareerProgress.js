                        ...
                        <div className="d-flex overflow-auto bg-gray p-3 rounded shadow-sm ">
                            {Object.keys(data.milestones).map((milestone) => (
                                <button
                                    ...
                                    className={`btn btn-link text-start fs-3 ml-1 ${selectedMilestone === milestone
                                        ? "text-primary border"
                                        : "text-secondary"
                                        }`}
                                >
                                ...
                                <div className="list-group">
                                    {milestoneKeys.map((key) => (
                                        <button
                                            ...
                                            className={`list-group-item list-group-item-action d-flex justify-content-between align-items-center ${selectedKey === key
                                        ...
                                        >
                                            ...
                                            <ChevronRight
                                                className={`h-4 w-4 ${selectedKey === key ? "rotate-90" : ""
                                                    }`}
                                            />
                                        </button>
                                    ))}
